...
const PUSH_CHANNELS = ['llm:chunk', 'llm:reasoning', 'llm:done', 'llm:error', 'llm:image', 'st:progress', 'menu:newChat', 'menu:newCharacter', 'menu:settings', 'menu:search', 'menu:history', 'menu:regenerate', 'updates:available', 'updates:progress'];
